...
import org.springframework.batch.experimental.core.repository.persistence.converter.StepExecutionConverter;
...
public class MongoStepExecutionDao implements StepExecutionDao {
	...
	public void saveStepExecution(StepExecution stepExecution) {
		org.springframework.batch.experimental.core.repository.persistence.StepExecution stepExecutionToSave = this.stepExecutionConverter
	...
	public void updateStepExecution(StepExecution stepExecution) {
		...
		org.springframework.batch.experimental.core.repository.persistence.StepExecution stepExecutionToUpdate = this.stepExecutionConverter
				.fromStepExecution(stepExecution);
	...
	public StepExecution getStepExecution(JobExecution jobExecution, Long stepExecutionId) {
		org.springframework.batch.experimental.core.repository.persistence.StepExecution stepExecution = this.mongoOperations
			.findById(stepExecutionId, org.springframework.batch.experimental.core.repository.persistence.StepExecution.class,
	...
	public StepExecution getLastStepExecution(JobInstance jobInstance, String stepName) {
		...
		List<org.springframework.batch.experimental.core.repository.persistence.StepExecution> stepExecutions = new ArrayList<>();
		Query query = query(where("jobInstanceId").is(jobInstance.getId()));
		List<org.springframework.batch.experimental.core.repository.persistence.JobExecution> jobExecutions = this.mongoOperations
			.find(query, org.springframework.batch.experimental.core.repository.persistence.JobExecution.class,
					JOB_EXECUTIONS_COLLECTION_NAME);
		for (org.springframework.batch.experimental.core.repository.persistence.JobExecution jobExecution : jobExecutions) {
		...
		// first one
		Optional<org.springframework.batch.experimental.core.repository.persistence.StepExecution> lastStepExecution = stepExecutions
			.stream()
			.min(Comparator
				.comparing(org.springframework.batch.experimental.core.repository.persistence.StepExecution::getCreateTime)
				.thenComparing(org.springframework.batch.experimental.core.repository.persistence.StepExecution::getId));
		if (lastStepExecution.isPresent()) {
			org.springframework.batch.experimental.core.repository.persistence.StepExecution stepExecution = lastStepExecution.get();
	...
	public void addStepExecutions(JobExecution jobExecution) {
		...
		List<StepExecution> stepExecutions = this.mongoOperations
			.find(query, org.springframework.batch.experimental.core.repository.persistence.StepExecution.class,
					STEP_EXECUTIONS_COLLECTION_NAME)
			.stream()
	...
	public long countStepExecutions(JobInstance jobInstance, String stepName) {
		...
		List<org.springframework.batch.experimental.core.repository.persistence.JobExecution> jobExecutions = this.mongoOperations
			.find(query, org.springframework.batch.experimental.core.repository.persistence.JobExecution.class,
					JOB_EXECUTIONS_COLLECTION_NAME);
		for (org.springframework.batch.experimental.core.repository.persistence.JobExecution jobExecution : jobExecutions) {
			List<org.springframework.batch.experimental.core.repository.persistence.StepExecution> stepExecutions = jobExecution
				.getStepExecutions();
			for (org.springframework.batch.experimental.core.repository.persistence.StepExecution stepExecution : stepExecutions) {
