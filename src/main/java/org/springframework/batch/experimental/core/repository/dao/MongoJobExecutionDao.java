...
public class MongoJobExecutionDao implements JobExecutionDao {
	...
	public void saveJobExecution(JobExecution jobExecution) {
		org.springframework.batch.experimental.core.repository.persistence.JobExecution jobExecutionToSave = this.jobExecutionConverter
	...
	public void updateJobExecution(JobExecution jobExecution) {
		...
		org.springframework.batch.experimental.core.repository.persistence.JobExecution jobExecutionToUpdate = this.jobExecutionConverter
				.fromJobExecution(jobExecution);
	...
	public JobExecution getLastJobExecution(JobInstance jobInstance) {
		...
		org.springframework.batch.experimental.core.repository.persistence.JobExecution jobExecution = this.mongoOperations.findOne(
	...
	public Set<JobExecution> findRunningJobExecutions(String jobName) {
		...
		List<JobInstance> jobInstances = this.mongoOperations
			.find(query, org.springframework.batch.experimental.core.repository.persistence.JobInstance.class,
	...
	public JobExecution getJobExecution(Long executionId) {
		org.springframework.batch.experimental.core.repository.persistence.JobExecution jobExecution = this.mongoOperations.findById(
				executionId, org.springframework.batch.experimental.core.repository.persistence.JobExecution.class,
				JOB_EXECUTIONS_COLLECTION_NAME);
		if (jobExecution == null) {
			return null;
		}
		org.springframework.batch.experimental.core.repository.persistence.JobInstance jobInstance = this.mongoOperations.findById(
				jobExecution.getJobInstanceId(),
				org.springframework.batch.experimental.core.repository.persistence.JobInstance.class, JOB_INSTANCES_COLLECTION_NAME);
